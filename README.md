<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=slice&height=180&color=0:140B03,45:F59E0B,100:F97316&text=Claude%20Usage%20Monitor&fontColor=ffffff&fontSize=34&fontAlign=69&fontAlignY=26&rotate=11&desc=CRT-styled%20Claude%20Code%20usage%20widget&descAlign=60&descAlignY=45&descSize=18" />
</p>
...
**Easiest:** Download the latest release and run the installer — no Python required.

👉 **[Get the latest release](https://github.com/Godimas101/claude-usage-monitor/releases/latest)**
